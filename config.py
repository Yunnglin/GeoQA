...
def get_argparse():
    ...
    parser.add_argument("--device", type=str, default="0", help="For distant debugging.")
    ...
    parser.add_argument("--train_batch_size", type=int, default=2, help="For distant debugging.")
